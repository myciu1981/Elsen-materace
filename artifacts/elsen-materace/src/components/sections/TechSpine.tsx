...
export default function TechSpine() {
  return (
    <>
      <section id="co-jest-w-srodku" className="py-12 md:py-16 bg-card border-y border-white/5 scroll-mt-20">
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg font-normal leading-relaxed">Dobry materac zaczyna się od tego, czego nie widać. Od sprężyn, pianek, materiałów i sposobu, w jaki wszystkie te warstwy ze sobą współpracują.<br />Dlatego nie wybieramy ich przypadkowo.</p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-4xl md:text-5xl text-foreground mb-4">Dobre podparcie zaczyna się od właściwej twardości</h2>
              ...
              <div className="space-y-6 text-muted-foreground text-lg font-normal leading-relaxed mb-12">
                <p>
                  Ciało nie jest proste jak deska. Materac powinien pracować razem z nim — podpierać tam, gdzie trzeba, i pozwalać mięśniom naprawdę odpocząć.
                </p>
                <p>
                  Zbyt miękki materac może powodować nadmierne zapadanie się ciała. Zbyt twardy — nie daje mu odpowiedniego podparcia. W obu przypadkach zamiast wygodnie spać, ciało przez całą noc próbuje znaleźć lepszą pozycję.
                </p>
                <p className="text-foreground font-normal border-l-2 border-primary pl-6 py-2">
                  Dlatego w ELSEN nie wybieramy twardości z gotowej tabeli. Bierzemy pod uwagę Twoją wagę, wzrost, pozycję, w której śpisz, i przede wszystkim to, jakiego podparcia potrzebujesz.
                  <br /><br />
                  Bo dobra twardość to nie ta sama dla wszystkich. To ta właściwa dla Ciebie.
                </p>
              </div>
